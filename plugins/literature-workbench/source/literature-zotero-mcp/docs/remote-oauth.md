...
- Names must be unique. Use a local build while this derivative remains private, for example: `claude mcp add literature-zotero-mcp -e ZOTERO_API_KEY=… -- node /path/to/literature-zotero-mcp/dist/index.js`.
