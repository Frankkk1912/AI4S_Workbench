...
const workbenchSourceRoot = "plugins/literature-workbench/source";
const bundles = [
...
function bundleRuntime() {
	...
	if (!esbuild) {
		throw new Error(
			"Missing literature-zotero-mcp esbuild dependency; run npm install in plugins/literature-workbench/source/literature-zotero-mcp first.",
		);
	}
