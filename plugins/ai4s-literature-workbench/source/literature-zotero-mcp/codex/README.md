...
| `findDuplicates()` | `zotero_find_duplicates` | Find duplicate candidates in a Zotero import batch |
| `applyImportPlan()` | `zotero_apply_import_plan` | Apply an approved Zotero import plan |
