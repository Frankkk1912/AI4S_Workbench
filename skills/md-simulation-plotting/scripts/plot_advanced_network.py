...
def plot_tier4_network(sys1_contact, sys2_contact, sys1_dccm, sys2_dccm, 
                       output_name="tier4_network", sys1_label="System 1", sys2_label="System 2",
                       network_xlabel="Residue i", network_ylabel="Residue j"):
    """
    ...
    if is_single:
        fig, axes = plt.subplots(1, 2, figsize=(6.8, 3.2), layout="constrained")
        ax_c1 = axes[0]
        ax_d1 = axes[1]
    else:
    ...
    if not is_single:
        ...
        fig.colorbar(im_c2, ax=ax_c2, fraction=0.046, pad=0.04, label="Contact Probability")
    ...
    if not is_single:
        ...
        fig.colorbar(im_d2, ax=ax_d2, fraction=0.046, pad=0.04, label="Cross-Correlation")
